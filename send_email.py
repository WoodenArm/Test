...
def send_email(file_path, subject):
    ...
    server.quit()
# def main():
#     message = 'Information has been added to the your_assistant.'
#     subject = 'The your assistant'
#     address = 'your_assistant_backup@aol.com'
#     send_email(address, subject, message)

# if __name__ == "__main__":
#     main()
name = 'Retro'
subject = f'The your assistant added article {name}.'
send_email(os.path.join('A Minimal Application.pdf'), subject)
# 'retro', 'cheatsheet.txt'